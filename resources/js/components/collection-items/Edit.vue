<template>
    <form @submit.prevent="updateCollectionItem(collectionItem)">
        ...
        <div class="mt-4">
            ...
            <button :disabled="isLoading" class="inline-flex items-center ml-3 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-3 rounded ml-2 disabled:opacity-75 disabled:cursor-not-allowed">
